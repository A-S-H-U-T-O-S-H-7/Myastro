  ...
  return <div>
      <div className="px-[10px] lg:px-[65px]">
        ...
        <p className="text-[#212529] py-2">
          Welcome to our yearly horoscope page! Here, you will find
          comprehensive predictions for each zodiac sign for the upcoming
          year. Our expert astrologers have carefully analyzed the planetary
          movements and alignments to provide you with accurate insights into
          your future.More…..
        </p>
        <Daysection />
        <HoroscopeContainer />
