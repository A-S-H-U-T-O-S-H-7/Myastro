  ...
  return <div>
      <div className="px-[10px] lg:px-[65px]">
        ...
        <p className="text-[#212529] py-2">
          Welcome to our Yesterday’s Horoscope page! Here, you will find
          insightful predictions for each zodiac sign for the previous day.
