...
const page = () => {
  return <div>
      <div className='px-[10px] lg:px-[65px]'>
        <h1 className='text-[#212529] py-1 flex justify-center text-[40px] font-heading font-bold'>Today's Horoscope</h1>
        <p className='flex justify-center font-semibold py-1 text-[#6c757d]'>Today</p>
        <p className='text-[#212529] py-2'>
          Discover what the stars have in store for you today with our daily
