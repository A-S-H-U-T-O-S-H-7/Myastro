  ...
  const fetchchats = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${ENV.API_URL}/admin/chats?${queryParams}`,
        {
          method: "GET",
          headers: {
      ...
      if (json.status) {
        console.log("Chats fetched successfully:", json.chats);
      ...
      console.error("Error fetching chats report:", error.message);
      setChats([]);
    } finally {
      setLoader(false);
    }
