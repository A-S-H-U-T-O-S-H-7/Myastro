...
const PaymentDetails = () => {
  ...
  return (
    <div>
    <h1 className=" text-[#3C0184] dark:text-[#22c7d5] font-bold font-heading text-[25px] mt-3 ml-[130px]">Payment Details</h1>
...
<div className="flex flex-wrap items-center gap-6">
 ...
 <AstroSearchBox searchTerm={searchTerm} onSearchChange={handleSearch} />
        ...
        <div className="overflow-x-auto">
          <table className="w-full table-auto shadow-md border-collapse min-w-[1000px]">
            <thead>
