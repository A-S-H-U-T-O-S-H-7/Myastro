...
function RechargeCard({value}) {
  return <div>
 <Link href="/user/payment"><div className="min-w-[240px] cursor-pointer hover:shadow-[0_4px_15px_rgba(93,102,255,0.5)] transition-shadow duration-300 min-h-[119px] border  rounded-[6px] ">
