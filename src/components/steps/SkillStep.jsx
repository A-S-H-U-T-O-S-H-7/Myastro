...
function SkillStep({ step, setStep, astrologerId }) {
    ...
    return (
        <Formik
            ...
            onSubmit={(values) => { handleSkills(values); }}
        >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Field
                                    as="select"
                                    name="maritalstatus"
                                    className="w-full border bg-white border-gray-300 rounded-lg px-4 py-2.5 text-sm placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-purple-500"
                                >
                                    <option value="" disabled>
                                        Select Status
                                    </option>
