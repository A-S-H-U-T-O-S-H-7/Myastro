...
import ENV from '../Env';
function SkillStep({ step, setStep, astrologerId }) {
    ...
    const skillDetailsSchema = Yup.object().shape({
        ...
        wheredidyouhereaboutmyastro: Yup.string()
            .required("Please select a source"),
        workinginonlineplatform: Yup.string()
            .required("Please indicate if you are working on another platform"),
    });
    ...
    return <Formik initialValues={{ profileImage: "", username: "", gender: "", dob: "", state: "", city: "", completeAddress: "", pincode: "", pannumber: "", adharnumber: "", gst: "", maritalstatus: "", primaryskill: "", allskills: [], languages: [], dailycontributionhour: "", experience: "", wheredidyouhereaboutmyastro: "", workinginonlineplatform: "", platform: "" }} validationSchema={skillDetailsSchema} onSubmit={values => {
          handleSkills(values);
        }}>
            ...
            <Form className="space-y-6">
              ...
              <div className="flex flex-col items-center space-y-2">
                <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-purple-500 dark:border-cyan-500">
                  ...
                  <input id="profileImage" type="file" accept="image/jpeg,image/png,image/jpg" className="hidden" onChange={e => {
