...
<div className="flex gap-2 items-center">
 <Image
   ...
   height={24}
 />
 <p className="hidden  md:block text-[#212529]  cursor-pointer text-sm">Ashutosh</p>
     ...
     <ul className="absolute right-2 top-full mt-1 bg-white border border-gray-300 rounded shadow-md w-40">
      ...
      >
        ...
        <ul className=" space-y-4 ">
          ...
          <li>
            <Link className="flex px-4 py-6 gap-3 bg-[#cd6dd2] font-semibold" href="/"><Image src="/myastrologo.png" width={15} height={15}/> My Astro</Link>
          </li>
