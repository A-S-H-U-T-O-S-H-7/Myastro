...
const AstrologerCard = () => {
  return (
    <div className="w-[365px] h-[174px] px-[16px] py-[8px] bg-white hover:shadow-2xl transition-shadow duration-300 shadow-md hover:shadow-[#542875] rounded-lg flex border ">
