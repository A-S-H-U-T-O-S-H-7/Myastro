...
function Freekundli() {
  return (
    ...
    <div className="w-[400px] md:w-[560px] px-6 py-6 border-4 border-[#B682FE] rounded-lg bg-[#f4f0eb] flex flex-col gap-5 items-center ">
        ...
        <button
          type="submit"
          className=" bg-[#B682FE] text-white px-6 py-2 rounded-md hover:bg-[#8756cb] focus:outline-none focus:ring-2 focus:ring-indigo-400 transition-all duration-300 ease-in-out"
        >
          Generate
        </button>
        </div>
